...
import com.github.ji4597056.support.exception.BaseException;
...
public enum ExceptionGenerator {
     ...
     */
    REQUEST_REPLAY_ERROR(HttpStatus.FORBIDDEN, RespCodeEnum.REQUEST_REPLAY_ERROR, "请求重复!"),

    /**
     * request path not found error
     */
    REQUEST_PATH_NOT_FOUND_ERROR(HttpStatus.NOT_FOUND, RespCodeEnum.REQUEST_PATH_NOT_FOUND, "未找到该路由!");
    ...
    static {
        for (ExceptionGenerator exceptionEnum : values()) {
            ...
            EXCEPTION_MAP.put(exceptionEnum.toString(), map);
        }
    }
